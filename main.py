    ...
    while running:
        if command == 'exit':
            ...
            print(
                ...
                "\tCommand: first_name - Returns the first name containing the English and Cyrillic spelling.\n"
                "\tCommand: last_name - Returns the last name variable containing the English and Cyrrilyc spelling.\n"
                "\tCommand: city - Returns the city object containing the city name and population.\n"
